-- 1. Crear el usuario en auth.users (Sin validación de conflicto)
...
-- 2. Crear identidad (Sin validación de conflicto)
...
-- 3. Crear Perfil vinculado al Tenant Demo (Sin validación de conflicto)
